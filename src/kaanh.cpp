...
namespace kaanh
{
	...
	auto createControllerRokaeXB4()->std::unique_ptr<aris::control::Controller>
	{
		...
		for (aris::Size i = 0; i < 6; ++i)
		{
			...
			double pos_factor[6]
			{
                131072.0 * 81 / 2 / PI, 131072.0 * 81 / 2 / PI, -131072.0 * 81 / 2 / PI, 131072.0 * 50 / 2 / PI, 131072.0 * 50 / 2 / PI, -131072.0 * 50 / 2 / PI
			};
			double max_pos[6]
			{
                165.0 / 360 * 2 * PI, 81.0 / 360 * 2 * PI,	95.0 / 360 * 2 * PI, 170.0 / 360 * 2 * PI, 120.0 / 360 * 2 * PI, 360.0 / 360 * 2 * PI,
			};
			double min_pos[6]
			{
                -165.0 / 360 * 2 * PI, -102.0 / 360 * 2 * PI, -143.0 / 360 * 2 * PI, -170.0 / 360 * 2 * PI, -120.0 / 360 * 2 * PI, -360.0 / 360 * 2 * PI
			};
			double max_vel[6]
			{
                450.0 / 360 * 2 * PI, 450.0 / 360 * 2 * PI, 450.0 / 360 * 2 * PI, 540.0 / 360 * 2 * PI, 540.0 / 360 * 2 * PI, 600.0 / 360 * 2 * PI,
			};
			double max_acc[6]
			{
                4500.0 / 360 * 2 * PI, 4500.0 / 360 * 2 * PI, 4500.0 / 360 * 2 * PI, 5400.0 / 360 * 2 * PI, 5400.0 / 360 * 2 * PI, 6000.0 / 360 * 2 * PI,
			};
